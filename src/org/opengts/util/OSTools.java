...
public class OSTools
{
    ...
    **/
    public static void main(String argv[])
    {
        ...
        Runtime rt = Runtime.getRuntime();
        Print.sysPrintln("Total Mem   : " + StringTools.rightAlign(StringTools.format(rt.totalMemory()/(1024.0*1024.0),"0.000"),8) + " Mb");
        Print.sysPrintln("Max Mem     : " + StringTools.rightAlign(StringTools.format(rt.maxMemory()  /(1024.0*1024.0),"0.000"),8) + " Mb");
        Print.sysPrintln("Free Mem    : " + StringTools.rightAlign(StringTools.format(rt.freeMemory() /(1024.0*1024.0),"0.000"),8) + " Mb");
