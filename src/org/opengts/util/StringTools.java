...
public class StringTools
{
  ...
  //private static final String DefaultCharEncoding     = CharEncoding_8859_1;
    ...
    ***         String does not exist within the target String.
    **/
    public static int indexOf(String t, String p, int n)
    {
    ...
    ***         character does not exist within the target String.
    **/
    public static int indexOf(String t, char c, int n)
    {
    ...
    ***         String does not exist within the target String.
    **/
    public static int indexOf(String tt, String pp[], int n)
    {
    ...
    ***         String does not exist within the target String.
    **/
    public static int indexOf(String tt, char cc[], int n)
    {
