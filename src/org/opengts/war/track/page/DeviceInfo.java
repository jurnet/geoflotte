  ...
  //public  static final String PARM_WORKORDER_ID           = "d_workid";
    ...
    private static void _addDeviceCommandHandler(DeviceCmdHandler dch)
    {
        ...
        if (!DCMap.containsKey(servID)) {
            ...
            DeviceCmdHandler dupDCH = DCMap.get(servID);
        ...
        try {
            ...
            if (Device.supportsPeriodicMaintenance()) {
                ...
                if (servTimeOK) {
                    ...
                    selDev.setLastServiceTime(lastServTS);
                    ...
                    selDev.setNextServiceTime(nextServTS);
                }
            }
            // Reset Fault codes
                ...
                public void write(PrintWriter out) throws IOException {
                    ...
                    if (Device.supportsPeriodicMaintenance()) {
                        ...
                        if (servTimeOK) {
                            ...
                            out.println(FormRow_SubSeparator());
                            out.println(FormRow_TextField(PARM_LAST_SERVICE_TIME, _uiEdit, i18n.getString("DeviceInfo.lastServiceTime","Last Service Time")+":", lastServDay, 13,13, dateFmtTxt));
                            out.println(FormRow_TextField(PARM_NEXT_SERVICE_TIME, _uiEdit, i18n.getString("DeviceInfo.nextServiceTime","Next Service Time")+":", nextServDay, 13,13, dateFmtTxt));
                        }
                    }
                    if (faultCodesOK && Device.supportsFaultCodes()) {
