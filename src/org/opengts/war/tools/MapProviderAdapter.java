        ...
        boolean outputHtml)
    {
        ...
        if (legendElem != null) {
            ...
            if (titleList.getLength() > 0) {
                ...
                String titleText = XMLTools.getNodeText(titleElem," ",false).trim();
                //Print.logInfo("Legend Title (before): " + titleText);
                legendTitle = RTConfig.insertKeyValues(titleText);
                //Print.logInfo("Legend Title (after): " + legendTitle);
            } else 
            if (outputHtml) {
    ...
    **/
    public String getIconSelectorLegend(boolean isFleet)
    {
        ...
        if ((legend != null) && legend.startsWith("<"+TAG_Legend)) {
            ...
            Print.logInfo("Legend: returning default legend");
            return legend;
        }
    }
