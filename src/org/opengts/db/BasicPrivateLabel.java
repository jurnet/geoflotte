    ...
    implements RTConfig.PropertySetter
{
  ...
  //private Map<String,String>          hostAliasMap            = null;
    ...
    **/
    ...
    {
        String df = this.getDateFormat().toLowerCase();
        return df.startsWith("yyyy/mm/dd")? true : false;
    }
    ...
    **/
    ...
    {
        String df = this.getDateFormat().toLowerCase();
        return df.startsWith("mm/dd/yyyy")? true : false;
    }
    ...
    **/
    ...
    {
        String df = this.getDateFormat().toLowerCase();
        return df.startsWith("dd/mm/yyyy")? true : false;
    }
    ...
    **/
    ...
    {
        String df = this.getDateFormat().toLowerCase();
        if (df.startsWith("yyyy/mm/dd") || df.startsWith("yyyy-mm-dd")) {
            return DateTime.DateStringFormat.YMD;
        } else
        if (df.startsWith("mm/dd/yyyy") || df.startsWith("mm-dd-yyyy")) {
            return DateTime.DateStringFormat.MDY;
        } else
        if (df.startsWith("dd/mm/yyyy") || df.startsWith("dd-mm-yyyy")) {
    ...
    public SendMail.SmtpProperties getSmtpProperties()
    {
        if (this.smtpProperties == null) {
            ...
            for (String smtpKey : RTKey.SMTP_PROPERTIES) {
                ...
                if (rtp.hasProperty(domKey)) {
                    smtpRTP.setProperty(smtpKey, rtp.getProperty(domKey,""));
                } else
                if (rtp.hasProperty(smtpKey)) {
                    smtpRTP.setProperty(smtpKey, rtp.getProperty(smtpKey,""));
                }
            }
