...
// ----------------------------------------------------------------------------
    ...
    private static Code _codeArray[] = new Code[] {
        ...
        new Code(STATUS_CORRIDOR_ARRIVE    , "COR.ARR"      , I18N.getString(StatusCodes.class,"StatusCodes.corridorArrive"  ,"Corridor_Arrive" ), true ),
        ...
        new Code(STATUS_CORRIDOR_DEPART    , "COR.DEP"      , I18N.getString(StatusCodes.class,"StatusCodes.corridorDepart"  ,"Corridor_Depart" ), true ),
        new Code(STATUS_JOB_DEPART         , "JOB.DEP"      , I18N.getString(StatusCodes.class,"StatusCodes.jobDepart"       ,"Job_Depart"      ), true ),
        ...
        new Code(STATUS_GEOFENCE_ACTIVE    , "GEO.ACT"      , I18N.getString(StatusCodes.class,"StatusCodes.geofActive"      ,"Geof_Active"     )       ),
        new Code(STATUS_CORRIDOR_ACTIVE    , "COR.ACT"      , I18N.getString(StatusCodes.class,"StatusCodes.corrActive"      ,"Corr_Active"     )       ),
        new Code(STATUS_GEOFENCE_INACTIVE  , "GEO.INA"      , I18N.getString(StatusCodes.class,"StatusCodes.geofInactive"    ,"Geof_Inactive"   )       ),
        new Code(STATUS_CORRIDOR_INACTIVE  , "COR.INA"      , I18N.getString(StatusCodes.class,"StatusCodes.corrInactive"    ,"Corr_Inactive"   )       ),
        new Code(STATUS_GEOBOUNDS_ENTER    , "STA.ENTR"     , I18N.getString(StatusCodes.class,"StatusCodes.stateEnter"      ,"State_Enter"     ), true ),
        new Code(STATUS_GEOBOUNDS_EXIT     , "STA.EXIT"     , I18N.getString(StatusCodes.class,"StatusCodes.stateExit"       ,"State_Exit"      ), true ),
        ...
        new Code(STATUS_IGNITION_ON        , "IGN.ON"       , I18N.getString(StatusCodes.class,"StatusCodes.ignitionOn"      ,"Ignition_On"     ), true ),
        new Code(STATUS_INPUT_ON           , "INP.ON"       , I18N.getString(StatusCodes.class,"StatusCodes.inputOn"         ,"Input_On"        )       ),
        new Code(STATUS_IGNITION_OFF       , "IGN.OFF"      , I18N.getString(StatusCodes.class,"StatusCodes.ignitionOff"     ,"Ignition_Off"    ), true ),
        new Code(STATUS_INPUT_OFF          , "INP.OFF"      , I18N.getString(StatusCodes.class,"StatusCodes.inputOff"        ,"Input_Off"       )       ),

        new Code(STATUS_OUTPUT_STATE       , "OUT.ST"       , I18N.getString(StatusCodes.class,"StatusCodes.outputs"         ,"Outputs"         )       ),
        new Code(STATUS_OUTPUT_ON          , "OUT.ON"       , I18N.getString(StatusCodes.class,"StatusCodes.outputOn"        ,"Output_On"       )       ),
        new Code(STATUS_OUTPUT_OFF         , "OUT.OFF"      , I18N.getString(StatusCodes.class,"StatusCodes.outputOff"       ,"Output_Off"      )       ),

        new Code(STATUS_ENGINE_START       , "ENG.START"    , I18N.getString(StatusCodes.class,"StatusCodes.engineStart"     ,"Engine_Start"    ), true ),
        new Code(STATUS_ENGINE_STOP        , "ENG.STOP"     , I18N.getString(StatusCodes.class,"StatusCodes.engineStop"      ,"Engine_Stop"     ), true ),
        ...
        new Code(STATUS_DOOR_OPEN_0        , "DOOR.OPEN.0"  , I18N.getString(StatusCodes.class,"StatusCodes.doorOpen_0"      ,"DoorOpen"        ), true ),
        new Code(STATUS_DOOR_OPEN_1        , "DOOR.OPEN.1"  , I18N.getString(StatusCodes.class,"StatusCodes.doorOpen_1"      ,"DoorOpen_1"      ), true ),
        new Code(STATUS_DOOR_OPEN_2        , "DOOR.OPEN.2"  , I18N.getString(StatusCodes.class,"StatusCodes.doorOpen_2"      ,"DoorOpen_2"      ), true ),

        new Code(STATUS_SEATBELT_ON_0      , "BELT.ON.0"    , I18N.getString(StatusCodes.class,"StatusCodes.seatbeltOn_0"    ,"SeatbeltOn"      )       ),
        new Code(STATUS_SEATBELT_ON_1      , "BELT.ON.1"    , I18N.getString(StatusCodes.class,"StatusCodes.seatbeltOn_1"    ,"SeatbeltOn_1"    )       ),
        ...
        new Code(STATUS_DOOR_CLOSE_0       , "DOOR.CLOSE.0" , I18N.getString(StatusCodes.class,"StatusCodes.doorClose_0"     ,"DoorClose"       ), true ),
        new Code(STATUS_DOOR_CLOSE_1       , "DOOR.CLOSE.1" , I18N.getString(StatusCodes.class,"StatusCodes.doorClose_1"     ,"DoorClose_1"     ), true ),
        new Code(STATUS_DOOR_CLOSE_2       , "DOOR.CLOSE.2" , I18N.getString(StatusCodes.class,"StatusCodes.doorClose_2"     ,"DoorClose_2"     ), true ),

        new Code(STATUS_SEATBELT_OFF_0     , "BELT.OFF.0"   , I18N.getString(StatusCodes.class,"StatusCodes.seatbeltOff_0"   ,"SeatbeltOff"     )       ),
        new Code(STATUS_SEATBELT_OFF_1     , "BELT.OFF.1"   , I18N.getString(StatusCodes.class,"StatusCodes.seatbeltOff_1"   ,"SeatbeltOff_1"   )       ),
        ...
        new Code(STATUS_ENTITY_CONNECT     , "ENTITY.CON"   , I18N.getString(StatusCodes.class,"StatusCodes.connect"         ,"Connect"         ), true ),
        new Code(STATUS_ENTITY_DISCONNECT  , "ENTITY.DIS"   , I18N.getString(StatusCodes.class,"StatusCodes.disconnect"      ,"Disconnect"      ), true ),
        ...
        new Code(STATUS_TRAILER_HOOK       , "TRAILER.HOOK" , I18N.getString(StatusCodes.class,"StatusCodes.trailerHook"     ,"Trailer_Hook"    ), true ),
        new Code(STATUS_TRAILER_UNHOOK     , "TRAILER.UNHK" , I18N.getString(StatusCodes.class,"StatusCodes.trailerUnook"    ,"Trailer_Unhook"  ), true ),
        ...
        new Code(STATUS_RFID_CONNECT       , "RFID.CON"     , I18N.getString(StatusCodes.class,"StatusCodes.rfidConnect"     ,"RFID_Connect"    ), true ),
        new Code(STATUS_RFID_DISCONNECT    , "RFID.DIS"     , I18N.getString(StatusCodes.class,"StatusCodes.rfidDisconnect"  ,"RFID_Disconn"    ), true ),
        new Code(STATUS_RFID_INVENTORY     , "RFID.INV"     , I18N.getString(StatusCodes.class,"StatusCodes.rfidInventory"   ,"RFID_Inventory"  ), true ),
        new Code(STATUS_PERSON_ENTER       , "PERSON.EMBARK", I18N.getString(StatusCodes.class,"StatusCodes.personEmbark"    ,"Person_Embark"   ), true ),
        new Code(STATUS_PERSON_EXIT        , "PERSON.DISEMB", I18N.getString(StatusCodes.class,"StatusCodes.personDisembark" ,"Person_Disembark"), true ),
        ...
        new Code(STATUS_COMMAND_ACK        , "COMMAND.ACK"  , I18N.getString(StatusCodes.class,"StatusCodes.commandAck"      ,"Command_Ack"     )       ),
        new Code(STATUS_COMMAND_NAK        , "COMMAND.NAK"  , I18N.getString(StatusCodes.class,"StatusCodes.commandNak"      ,"Command_Nak"     )       ),
        new Code(STATUS_DUTY_ON            , "DUTY_ON"      , I18N.getString(StatusCodes.class,"StatusCodes.dutyOn"          ,"Duty_On"         )       ),
        new Code(STATUS_DUTY_OFF           , "DUTY_OFF"     , I18N.getString(StatusCodes.class,"StatusCodes.dutyOff"         ,"Duty_Off"        )       ),
        new Code(STATUS_PANIC_ON           , "PANIC_ON"     , I18N.getString(StatusCodes.class,"StatusCodes.panicOn"         ,"Panic"           ), true ),
        new Code(STATUS_PANIC_OFF          , "PANIC_OFF"    , I18N.getString(StatusCodes.class,"StatusCodes.panicOff"        ,"Panic_Off"       ), true ),
        new Code(STATUS_ALARM_ON           , "ALARM_ON"     , I18N.getString(StatusCodes.class,"StatusCodes.alarmOn"         ,"Alarm"           ), true ),
        new Code(STATUS_ALARM_OFF          , "ALARM_OFF"    , I18N.getString(StatusCodes.class,"StatusCodes.alarmOff"        ,"Alarm_Off"       ), true ),
        new Code(STATUS_ASSIST_ON          , "ASSIST_ON"    , I18N.getString(StatusCodes.class,"StatusCodes.assistOn"        ,"Assist"          ), true ),
        new Code(STATUS_ASSIST_OFF         , "ASSIST_OFF"   , I18N.getString(StatusCodes.class,"StatusCodes.assistOff"       ,"Assist_Off"      ), true ),
        new Code(STATUS_MANDOWN_ON         , "MANDOWN_ON"   , I18N.getString(StatusCodes.class,"StatusCodes.mandownOn"       ,"ManDown"         ), true ),
        new Code(STATUS_MANDOWN_OFF        , "MANDOWN_OFF"  , I18N.getString(StatusCodes.class,"StatusCodes.mandownOff"      ,"ManDown_Off"     ), true ),
        new Code(STATUS_MEDICAL_ON         , "MEDICAL_ON"   , I18N.getString(StatusCodes.class,"StatusCodes.medicalOn"       ,"Medical"         ), true ),
        new Code(STATUS_MEDICAL_OFF        , "MEDICAL_OFF"  , I18N.getString(StatusCodes.class,"StatusCodes.medicalOff"      ,"Medical_Off"     ), true ),
        ...
        new Code(STATUS_INTRUSION_OFF      , "INTRUSION_OFF", I18N.getString(StatusCodes.class,"StatusCodes.intrusionOff"    ,"Intrusion_Off"   ), true ),
        new Code(STATUS_BREACH_ON          , "BREACH_ON"    , I18N.getString(StatusCodes.class,"StatusCodes.breachOn"        ,"Breach"          ), true ),
        new Code(STATUS_BREACH_OFF         , "BREACH_OFF"   , I18N.getString(StatusCodes.class,"StatusCodes.breachOff"       ,"Breach_Off"      ), true ),
        new Code(STATUS_VIBRATION_ON       , "VIBRATION_ON" , I18N.getString(StatusCodes.class,"StatusCodes.vibrationOn"     ,"Vibration"       ), true ),
        new Code(STATUS_VIBRATION_OFF      , "VIBRATION_OFF", I18N.getString(StatusCodes.class,"StatusCodes.vibrationOff"    ,"Vibration_Off"   ), true ),
        new Code(STATUS_PTO_ON             , "PTO_ON"       , I18N.getString(StatusCodes.class,"StatusCodes.ptoOn"           ,"PTO_On"          )       ),
        new Code(STATUS_PTO_OFF            , "PTO_OFF"      , I18N.getString(StatusCodes.class,"StatusCodes.ptoOff"          ,"PTO_Off"         )       ),

        new Code(STATUS_CARJACK_DISABLED   , "CARJACK_DISAB", I18N.getString(StatusCodes.class,"StatusCodes.carjack.disabled","Carjack_Disable" )       ),
        new Code(STATUS_CARJACK_ENABLED    , "CARJACK_ENABL", I18N.getString(StatusCodes.class,"StatusCodes.carjack.enabled" ,"Carjack_Enable"  )       ),
        new Code(STATUS_CARJACK_STANDBY    , "CARJACK_STDBY", I18N.getString(StatusCodes.class,"StatusCodes.carjack.standby" ,"Carjack_StandBy" )       ),
        new Code(STATUS_CARJACK_ARMED      , "CARJACK_ARMED", I18N.getString(StatusCodes.class,"StatusCodes.carjack.armed"   ,"Carjack_Armed"   ), true ),
        ...
        new Code(STATUS_POWER_FAILURE      , "POWERFAIL"    , I18N.getString(StatusCodes.class,"StatusCodes.powerFail"       ,"Power_Fail"      ), true ),
        new Code(STATUS_POWER_ALARM        , "POWERALARM"   , I18N.getString(StatusCodes.class,"StatusCodes.powerAlarm"      ,"Power_Alarm"     ), true ),
        new Code(STATUS_POWER_RESTORED     , "POWERRESTORE" , I18N.getString(StatusCodes.class,"StatusCodes.powerRestore"    ,"Power_Restore"   ), true ),
        new Code(STATUS_POWER_OFF          , "POWEROFF"     , I18N.getString(StatusCodes.class,"StatusCodes.powerOff"        ,"Power_Off"       ), true ),
        new Code(STATUS_POWER_ON           , "POWERON"      , I18N.getString(StatusCodes.class,"StatusCodes.powerOn"         ,"Power_On"        ), true ),
        new Code(STATUS_GPS_EXPIRED        , "GPS.EXPIRE"   , I18N.getString(StatusCodes.class,"StatusCodes.gpsExpired"      ,"GPS_Expired"     )       ),
        new Code(STATUS_GPS_FAILURE        , "GPS.FAILURE"  , I18N.getString(StatusCodes.class,"StatusCodes.gpsFailure"      ,"GPS_Failure"     ), true ),
        ...
        new Code(STATUS_CONNECTION_FAILURE , "CONN.FAILURE" , I18N.getString(StatusCodes.class,"StatusCodes.connectFailure"  ,"Connect_Failure" ), true ),
        new Code(STATUS_CONNECTION_RESTORED, "CONN.RESTORE" , I18N.getString(StatusCodes.class,"StatusCodes.connectRestore"  ,"Connect_Restore" )       ),
        ...
        new Code(STATUS_CONFIG_START       , "CFG.START"    , I18N.getString(StatusCodes.class,"StatusCodes.configStart"     ,"Config_Start"    ), true ),
        new Code(STATUS_CONFIG_COMPLETE    , "CFG.COMPLETE" , I18N.getString(StatusCodes.class,"StatusCodes.configComplete"  ,"Config_Complete" ), true ),
